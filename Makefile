OBJS 	= block.o dilists.o list_main.o blk_main.o dir.o funcs.o metadata.o dirtest.o
SOURCE	= blk_main.c block.c dilists.c dinode.c dir.c funcs.c metadata.c dirtest.c
...
blktest: blk_main.o block.o 
	$(CC) -g blk_main.o block.o -o blktest
